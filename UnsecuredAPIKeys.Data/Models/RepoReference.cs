...
namespace UnsecuredAPIKeys.Data.Models
{
    public class RepoReference
    {
        ...
        /// <summary>
        /// The timestamp of the last push to the repository as reported by GitHub.
        /// This is sourced from item.Repository.PushedAt in Octokit — not generated by the scraper.
        /// Used to advance the LastRepoPushedSeenUTC checkpoint in SearchQuery accurately.
        /// </summary>
        public DateTimeOffset? RepoPushedAt { get; set; }
    }
}
